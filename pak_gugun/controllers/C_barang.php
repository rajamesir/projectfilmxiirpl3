...
class C_barang{
    ...
    public function update ($id_inventory, $nama_barang, $jumlah_barang, $jenis_barang, $tanggal_masuk, $tanggal_keluar, $id_pemilik) {
        ...
        $sql = "UPDATE barang SET nama_barang = '$nama_barang', jumlah_barang = '$jumlah_barang', jenis_barang = '$jenis_barang', tanggal_masuk = '$tanggal_masuk', ta      nggal_keluar = '$tanggal_keluar', id_pemilik = ' $id_pemilik' WHERE  id_inventory = '$id_inventory'";
