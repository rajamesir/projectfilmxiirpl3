...
<table>
                               ...
                               <tr> <div class="form-group">
                                ...
                                <tr><td>Nama</td><td>:</td><td class="form-group">
                                    <input type="text" class="form-control form-control-user"
                                        placeholder="Nama" name="nama">
</td></tr>
                                <!--untuk menampung email dari user-->
                               <tr><td>Email</td><td>:</td> <td class="form-group">
                                    <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Email Address" name="email">
</td></tr>

                                <!--untuk menampung password dari user-->
                                <tr><td>Password</td><td>:</td><td class="form-group">
...
<input type="text" class="form-control form-control-user" id="role"
                                ...
                                <!--untuk menampung nama dari user-->
                                <tr><td><td></td></td><td class="form-group">
